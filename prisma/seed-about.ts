/**
 * Seed script: popula os dados iniciais da Página Sobre Nós no banco de dados.
 * Execute: npx ts-node --compiler-options '{"module":"CommonJS"}' prisma/seed-about.ts
 */
...
Nossa jornada é marcada por um compromisso inabalável com o benefício e a qualidade de vida dos nossos clientes, e estamos ansiosos para continuar essa trajetória ao seu lado, trazendo as melhores oportunidades imobiliárias diretamente até você. Obrigado por fazer parte dessa história conosco.`,
      ...
      missionText:
        'Facilitar e intermediar a compra e venda de imóveis, proporcionando um serviço de qualidade que atenda às necessidades dos clientes. Oferecer suporte especializado, orientação durante o processo de transação imobiliária e garantir a satisfação do cliente.',
      visionText:
        'Se tornar uma referência no mercado digital, inovando constantemente para oferecer as melhores soluções imobiliárias, expandindo sua atuação para novas regiões e mantendo um padrão de excelência no atendimento ao cliente.',
      valuesText: valuesData,

      // Álvares Florence
      cityName: 'Álvares Florence',
      cityText: `Essa é a Maior cidadezinha do Mundo, aproximadamente 4 mil habitantes. Aqui tem Qualidade de Vida, Saúde Mental, Saúde Espiritual e Social, Amizades, Portas e Janelas abertas sem medo da violência, sua Família segura e feliz, para a terceira idade então, é um Paraíso. A 40 km dos rios Turvo e Marinheiro, de alto padrão de pesca. A 10 km de Votuporanga, uma das cidades brasileiras que mais se desenvolveu nos últimos anos. A 100 Km da Metrópole Regional São José do Rio Preto, acesso por pista dupla sem pedágio, Rodovia Euclides da Cunha e Rodovia Washington Luís. Álvares Florence tem índice de criminalidade praticamente zero, é um município amplo em território, com uma natureza exuberante e várias propriedades rurais.`,
      cityImageUrl: null,
      ...
      agentImageUrl: null,
      agentBio:
        'Corretor de imóveis com ampla experiência no mercado regional de Álvares Florence e Votuporanga. Especialista em imóveis urbanos e rurais, comprometido em encontrar as melhores oportunidades para você e sua família.',
    },
  })
